...
#We haven't used the Employee class (and employees table) at all yet. If you look at this table's column
#structure, you'll find that it has a store_id (integer) column. This is a column that identifies which
...
@store1.employees.create(first_name: "Surrey",
                         last_name: "Virani",
                         hourly_rate: 60)
@store1.employees.create(first_name: "Jessica",
                         last_name: "Smith",
                         hourly_rate: 55)
@store1.employees.create(first_name: "Deb",
                         last_name: "Burrel",
                         hourly_rate: 65)

@store2.employees.create(first_name: "David",
                         last_name: "Rose",
                         hourly_rate: 67)
@store2.employees.create(first_name: "John",
                         last_name: "Martins",
                         hourly_rate: 52)
@store2.employees.create(first_name: "Paul",
                         last_name: "Gladwell",
                         hourly_rate: 60)
